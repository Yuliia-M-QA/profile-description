...
test('Visit submenu pages are accessible', async ({ page }) => {
  ...
  // Вибираємо "Visiting Regulations"
  await page.getByRole('link', { name: 'Visiting Regulations' }).click();
  await expect(page.locator('h1')).toContainText('Visiting Regulations');
