...
test('test', async ({ page }) => {
  ...
  await page1.getByRole('row', { name: 'Bilet Ulgowy jednorazowy' }).getByRole('button').nth(1).click();
  ...
  await page1.getByRole('checkbox', { name: 'Oświadczam, że zapoznałem si' }).check();
