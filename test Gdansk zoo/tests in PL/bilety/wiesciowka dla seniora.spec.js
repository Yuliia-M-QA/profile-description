...
test('test', async ({ page }) => {
  ...
  await page1.getByText('Zwiedzanie ZOO').click();
  await page1.getByRole('row', { name: 'Wejściówka dla seniora wejści' }).getByRole('button').nth(1).click();
  ...
  await page1.getByRole('button', { name: 'ODBIERAM' }).click();
});